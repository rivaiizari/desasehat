...
<!-- BS Stepper -->
<link rel="stylesheet" href="<?= base_url().BASE_URL ?>/assets_lte/plugins/bs-stepper/css/bs-stepper.min.css" />
<!-- dropzonejs -->
...
<section class="content">
    <div class="container-fluid">
        ...
        <div class="card card-default">
            ...
            <!-- /.card-body -->
            <div class="card-footer">Visit <a href="https://github.com/istvan-ujjmeszaros/bootstrap-duallistbox#readme">Bootstrap Duallistbox</a> for more examples and information about the plugin.</div>
        </div>
        <!-- /.card -->
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="card card-primary">
                    ...
                    <div class="card-footer">Visit <a href="https://getdatepicker.com/5-4/">tempusdominus </a> for more examples and information about the plugin.</div>
                    <!-- /.card-body -->
                </div>
                <!-- /.card -->
                ...
                <div class="card card-success">
                    ...
                    <!-- /.card-body -->
                    <div class="card-footer">Many more skins available. <a href="https://bantikyan.github.io/icheck-bootstrap/">Documentation</a></div>
                </div>
                <!-- /.card -->
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card card-default">
                    ...
                    <!-- /.card-body -->
                    <div class="card-footer">Visit <a href="https://github.com/Johann-S/bs-stepper/#how-to-use-it">bs-stepper documentation</a> for more examples and information about the plugin.</div>
                </div>
                <!-- /.card -->
            </div>
        </div>
...
<!-- BS-Stepper -->
<script src="<?= base_url().BASE_URL ?>/assets_lte/plugins/bs-stepper/js/bs-stepper.min.js"></script>
<!-- dropzonejs -->
