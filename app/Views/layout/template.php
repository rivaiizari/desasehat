...
<html lang="en">
    <head>
        ...
        <!-- Font Awesome -->
        <link rel="stylesheet" href="<?= base_url().BASE_URL ?>/assets_lte/plugins/fontawesome-free/css/all.min.css" />
        <!-- Theme style -->
        <link rel="stylesheet" href="<?= base_url().BASE_URL ?>/assets_lte/css/adminlte.min.css" />
        <!-- notifikasi -->
    ...
    <body class="hold-transition sidebar-mini">
        ...
        <div class="wrapper">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                            <a href="#" class="dropdown-item">
                                <!-- Message Start -->
                                <div class="media">
                                    <img src="<?= base_url().BASE_URL ?>/assets_lte/img/user1-128x128.jpg" alt="User Avatar" class="img-size-50 mr-3 img-circle" />
                            ...
                            <a href="#" class="dropdown-item">
                                <!-- Message Start -->
                                <div class="media">
                                    <img src="<?= base_url().BASE_URL ?>/assets_lte/img/user8-128x128.jpg" alt="User Avatar" class="img-size-50 img-circle mr-3" />
                                    <div class="media-body">
                                        <h3 class="dropdown-item-title">
                                            John Pierce
                            ...
                            <a href="#" class="dropdown-item">
                                <!-- Message Start -->
                                <div class="media">
                                    <img src="<?= base_url().BASE_URL ?>/assets_lte/img/user3-128x128.jpg" alt="User Avatar" class="img-size-50 img-circle mr-3" />
                                    <div class="media-body">
                                        <h3 class="dropdown-item-title">
                                            Nora Silvester
            ...
            <aside class="main-sidebar sidebar-dark-primary elevation-4">
                ...
                <a href="/" class="brand-link">
                    <img src="<?= base_url().BASE_URL ?>/assets_lte/img/AdminLTELogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: 0.8;" />
        ...
        <!-- Bootstrap 4 -->
        <script src="<?= base_url().BASE_URL ?>/assets_lte/plugins/bootstrap/js/bootstrap.bundle.min.js"></script>
        <!-- AdminLTE App -->
        <script src="<?= base_url().BASE_URL ?>/assets_lte/js/adminlte.min.js"></script>
        <!-- AdminLTE for demo purposes -->
        <!-- <script src="<?= base_url().BASE_URL ?>/assets_lte/js/demo.js"></script> -->
          <!-- notif -->
